...
<style lang="sass">
    .title
        @apply text-white text-๒xl font-normal break-words

    .wrapper
        @apply relative aspect-w-๑ aspect-h-๑

    .button
        @apply absolute border-๐ px-๔ rounded
        height: ๑๐๐%
        background-color: #๐๐๗aff
        outline: none
        -webkit-tap-highlight-color: transparent        

    .overlay
        @apply top-๐ left-๐ absolute w-๐ h-full
        background-color: rgba(๒๕๕,๒๕๕,๒๕๕,.๒๕)
        transition: width .๔๒๕s ease-out
    ...
    .--playing
        animation: play var(--duration) ๐s ๑ ease-out, fade-out .๗๕s var(--duration) ๑ ease-out
